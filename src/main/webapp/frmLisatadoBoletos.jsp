                ...
                <body>
                    ...
                    <% System.out.println("Cargando lista de boletos..."); %>
                        ...
                        <table>
                            ...
                            <% BoletoDAO dao=new BoletoDAO(); List<Boleto> boletos = dao.getBoletos();
                                ...
                                <% } else { for(Boleto boleto : boletos){ %>
                                    <tr>
                                        <td>
                                            <%= boleto.getIdBoleto() %>
                                        </td>
                                        ...
                                        <td>
                                            <%= boleto.getIdTransaccion() %>
                                        </td>
                                        <td>$<%= String.format("%.2f", boleto.getPrecio()) %>
                                        </td>
                                        <td>
